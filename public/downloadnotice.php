...
<p><?php echo $lang_downloadnotice['text_private_tracker_note_one']?><i>(<?php echo $lang_downloadnotice['text_learn_more']?><a class="faqlink" href="<?php echo NEXUSWIKIURL?>/Private Tracker" target="_blank" rel="noopener"><?php echo $lang_downloadnotice['text_nexuswiki']?></a>)</i></p>
<p><?php echo $lang_downloadnotice['text_private_tracker_note_two']?><i>(<?php echo $lang_downloadnotice['text_see_ratio']?><a class="faqlink" href="faq.php#id23" target="_blank" rel="noopener"><?php echo $lang_downloadnotice['text_faq']?></a>)</i></p>
...
<p><?php echo $lang_downloadnotice['text_allowed_clients_note_one']?><i>(<?php echo $lang_downloadnotice['text_why_banned']?><a class="faqlink" href="<?php echo NEXUSWIKIURL?>/客户端测试报告" target="_blank" rel="noopener"><?php echo $lang_downloadnotice['text_nexuswiki']?></a>)</i></p>
...
<a href="http://www.utorrent.com/download.php" target="_blank" rel="noopener" title="<?php echo $lang_downloadnotice['title_download']?>uTorrent"><img src="pic/utorrentbig.png" alt="uTorrent" /></a>
</td>
<td class="embedded" style="text-align: center; padding: 5px;" width="50%">
<a href="http://azureus.sourceforge.net/download.php" target="_blank" rel="noopener" title="<?php echo $lang_downloadnotice['title_download']?>Vuze"><img src="pic/vuzebig.png" alt="Vuze" /></a>
</td>
</tr>
<tr>
<td class="embedded" style="text-align: center; padding: 5px;">
<div class="big"><a href="http://www.utorrent.com/download.php" target="_blank" rel="noopener" title="<?php echo $lang_downloadnotice['title_download']?>uTorrent"><b>uTorrent</b></a></div>
<div><?php echo $lang_downloadnotice['text_for']?>Windows</div>
</td>
<td class="embedded" style="text-align: center; padding: 5px;">
<div class="big"><a href="http://azureus.sourceforge.net/download.php" target="_blank" rel="noopener" title="<?php echo $lang_downloadnotice['title_download']?>Vuze"><b>Vuze</b></a></div>
...
<form action="?" method="post"><p><?php echo $lang_downloadnotice['text_for_more_information_read']?><a class="faqlink" href="rules.php" target="_blank" rel="noopener"><?php echo $lang_downloadnotice['text_rules']?></a><?php echo $lang_downloadnotice['text_and']?><a class="faqlink" href="faq.php" target="_blank" rel="noopener"><?php echo $lang_downloadnotice['text_faq']?></a><br />
